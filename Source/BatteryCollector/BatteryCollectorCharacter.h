...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Power")
	// Accessor function for character power
	float GetCurrentPower();

	 /*Update function for character power
	 * @param CharacterPowerChange is the amount to change the power by, and it can be positive or negative
	 */
	UFUNCTION(BlueprintCallable, Category = "Power")
	void UpdatePower(float CharacterPowerChange);
...
protected:
	...
	// Поднимаем объект внутри зоны сбора по нажатию клавиши
...
public:
	...
	// Возвращает зону сбора объектов
